...
public class AppointmentService {
	...
	public String viewAppointments()
	 {
		return appointmentObj.viewAppointments(); 
	...
	{
		String output = appointmentObj.insertAppointment(doctor_id,doctor_name,hospital_id,name,appointment_time,appointment_date,WardNo);
	...
	public String updateAppointment(String appointmentViewData)
	{
		...
		String output = appointmentObj.updateAppointment(ref_id, doctor_id, doctor_name,hospital_id,name,appointment_time,appointment_date,WardNo);
	...
	public String deleteAppointment(String appointmentViewData)
	{
		...
		String output = appointmentObj.deleteAppointment(ref_id);
		return output;
	}
