...
/**
 * Servlet implementation class AppViewAPI
 */
@WebServlet("/AppViewAPI")
public class AppViewAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = appointmentObj.insertAppointmentView(request.getParameter("doctor_id"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = appointmentObj.updateAppointmentView(paras.get("hidRef_IDSave").toString(),
															 paras.get("doctor_id").toString(),
															 paras.get("doctor_name").toString(),
															 paras.get("hospital_id").toString(),
															 paras.get("name").toString(),
															 paras.get("appointment_time").toString(),
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = appointmentObj.deleteAppointmentView(paras.get("ref_id").toString());
